...
# Resource: Manages a google_netapp_kmsconfig resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleNetappKmsconfig do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { crypto_key_name: 'test-value', location: 'test-value', name: 'test-value' } }

  describe ':google_netapp_kmsconfig' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_netapp_kmsconfig('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_netapp_kmsconfig', 'test')
        validate_required_attributes(config, [:crypto_key_name, :location, :name])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_netapp_kmsconfig)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.service_account).to eq("${google_netapp_kmsconfig.test.service_account}")
        expect(ref.terraform_labels).to eq("${google_netapp_kmsconfig.test.terraform_labels}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_netapp_kmsconfig('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_netapp_kmsconfig('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_netapp_kmsconfig', 'opt')
        expect(config).to have_key('description')
      end
      ...
      it 'includes labels when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_netapp_kmsconfig('opt', required_attrs.merge(labels: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_netapp_kmsconfig', 'opt')
        expect(config).to have_key('labels')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_netapp_kmsconfig('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_netapp_kmsconfig', 'typed')
        expect(config['crypto_key_name']).to be_a(String)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_netapp_kmsconfig('first', required_attrs)
        synth.google_netapp_kmsconfig('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_netapp_kmsconfig')
