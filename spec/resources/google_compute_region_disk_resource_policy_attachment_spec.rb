...
# Resource: Manages a google_compute_region_disk_resource_policy_attachment resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleComputeRegionDiskResourcePolicyAttachment do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { disk: 'test-value', name: 'test-value' } }

  describe ':google_compute_region_disk_resource_policy_attachment' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_disk_resource_policy_attachment('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_compute_region_disk_resource_policy_attachment)
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_disk_resource_policy_attachment('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_compute_region_disk_resource_policy_attachment', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_disk_resource_policy_attachment('first', required_attrs)
        synth.google_compute_region_disk_resource_policy_attachment('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_compute_region_disk_resource_policy_attachment')
