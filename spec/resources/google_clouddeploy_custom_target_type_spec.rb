...
# Resource: Manages a google_clouddeploy_custom_target_type resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleClouddeployCustomTargetType do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { location: 'test-value', name: 'test-value' } }

  describe ':google_clouddeploy_custom_target_type' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_clouddeploy_custom_target_type('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_clouddeploy_custom_target_type('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_clouddeploy_custom_target_type)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.project).to eq("${google_clouddeploy_custom_target_type.test.project}")
        expect(ref.terraform_labels).to eq("${google_clouddeploy_custom_target_type.test.terraform_labels}")
        expect(ref.uid).to eq("${google_clouddeploy_custom_target_type.test.uid}")
        expect(ref.update_time).to eq("${google_clouddeploy_custom_target_type.test.update_time}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_clouddeploy_custom_target_type('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes annotations when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_clouddeploy_custom_target_type('opt', required_attrs.merge(annotations: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'omits custom_actions when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_clouddeploy_custom_target_type('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_clouddeploy_custom_target_type('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_clouddeploy_custom_target_type', 'opt')
        expect(config).to have_key('description')
      end
      ...
      it 'includes labels when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_clouddeploy_custom_target_type('opt', required_attrs.merge(labels: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_clouddeploy_custom_target_type', 'opt')
        expect(config).to have_key('labels')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_clouddeploy_custom_target_type('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_clouddeploy_custom_target_type', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_clouddeploy_custom_target_type('first', required_attrs)
        synth.google_clouddeploy_custom_target_type('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_clouddeploy_custom_target_type')
