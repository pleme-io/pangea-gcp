...
# Resource: Manages a google_compute_interconnect_attachment_group resource
  ...
  describe ':google_compute_interconnect_attachment_group' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.google_compute_interconnect_attachment_group('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_compute_interconnect_attachment_group('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_compute_interconnect_attachment_group)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_interconnect_attachment_group('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes attachments when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_interconnect_attachment_group('opt', required_attrs.merge(attachments: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_interconnect_attachment_group', 'opt')
        expect(config).to have_key('attachments')
      end

      it 'omits attachments when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_interconnect_attachment_group('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_interconnect_attachment_group', 'opt')
        expect(config).to have_key('description')
      end
      ...
      it 'includes interconnect_group when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_interconnect_attachment_group('opt', required_attrs.merge(interconnect_group: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_interconnect_attachment_group', 'opt')
        expect(config).to have_key('interconnect_group')
      end

      it 'omits interconnect_group when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_interconnect_attachment_group('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_interconnect_attachment_group('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_interconnect_attachment_group('first', required_attrs)
        synth.google_compute_interconnect_attachment_group('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_compute_interconnect_attachment_group')
