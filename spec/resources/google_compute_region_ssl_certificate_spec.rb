...
# Resource: Manages a google_compute_region_ssl_certificate resource
  ...
  describe ':google_compute_region_ssl_certificate' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.google_compute_region_ssl_certificate('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_compute_region_ssl_certificate('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_compute_region_ssl_certificate)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.project).to eq("${google_compute_region_ssl_certificate.test.project}")
        expect(ref.region).to eq("${google_compute_region_ssl_certificate.test.region}")
        expect(ref.self_link).to eq("${google_compute_region_ssl_certificate.test.self_link}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_ssl_certificate('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_ssl_certificate('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_ssl_certificate('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_ssl_certificate('first', required_attrs)
        synth.google_compute_region_ssl_certificate('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_compute_region_ssl_certificate')
