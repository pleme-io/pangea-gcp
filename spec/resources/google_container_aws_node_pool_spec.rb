...
# Resource: Manages a google_container_aws_node_pool resource
  ...
  describe ':google_container_aws_node_pool' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.google_container_aws_node_pool('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_container_aws_node_pool('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_container_aws_node_pool)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.reconciling).to eq("${google_container_aws_node_pool.test.reconciling}")
        expect(ref.state).to eq("${google_container_aws_node_pool.test.state}")
        expect(ref.uid).to eq("${google_container_aws_node_pool.test.uid}")
        expect(ref.update_time).to eq("${google_container_aws_node_pool.test.update_time}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_container_aws_node_pool('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes annotations when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_container_aws_node_pool('opt', required_attrs.merge(annotations: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'omits update_settings when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_container_aws_node_pool('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_container_aws_node_pool', 'minimal')
        expect(config).not_to have_key('update_settings')
      end
    end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_container_aws_node_pool('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_container_aws_node_pool('first', required_attrs)
        synth.google_container_aws_node_pool('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_container_aws_node_pool')
