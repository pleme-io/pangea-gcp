...
# Resource: Manages a google_compute_instance_group_membership resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleComputeInstanceGroupMembership do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { instance: 'test-value', instance_group: 'test-value' } }

  describe ':google_compute_instance_group_membership' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_instance_group_membership('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_compute_instance_group_membership', 'test')
        validate_required_attributes(config, [:instance, :instance_group])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_compute_instance_group_membership)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_instance_group_membership('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes zone when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_instance_group_membership('opt', required_attrs.merge(zone: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_instance_group_membership', 'opt')
        expect(config).to have_key('zone')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_instance_group_membership('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_compute_instance_group_membership', 'typed')
        expect(config['instance']).to be_a(String)
        expect(config['instance_group']).to be_a(String)
      end
    end
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_instance_group_membership('first', required_attrs)
        synth.google_compute_instance_group_membership('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_compute_instance_group_membership')
