...
# Resource: Manages a google_filestore_snapshot resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleFilestoreSnapshot do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { instance: 'test-value', location: 'test-value', name: 'test-value' } }

  describe ':google_filestore_snapshot' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_filestore_snapshot('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_filestore_snapshot', 'test')
        validate_required_attributes(config, [:instance, :location, :name])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_filestore_snapshot('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_filestore_snapshot)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.state).to eq("${google_filestore_snapshot.test.state}")
        expect(ref.terraform_labels).to eq("${google_filestore_snapshot.test.terraform_labels}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_filestore_snapshot('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_filestore_snapshot('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_filestore_snapshot', 'opt')
        expect(config).to have_key('description')
      end
      ...
      it 'includes labels when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_filestore_snapshot('opt', required_attrs.merge(labels: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_filestore_snapshot', 'opt')
        expect(config).to have_key('labels')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_filestore_snapshot('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_filestore_snapshot', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_filestore_snapshot('first', required_attrs)
        synth.google_filestore_snapshot('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_filestore_snapshot')
