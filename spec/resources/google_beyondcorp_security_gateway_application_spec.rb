...
# Resource: Manages a google_beyondcorp_security_gateway_application resource
  ...
  describe ':google_beyondcorp_security_gateway_application' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.google_beyondcorp_security_gateway_application('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_beyondcorp_security_gateway_application('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_beyondcorp_security_gateway_application)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_beyondcorp_security_gateway_application('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes display_name when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_beyondcorp_security_gateway_application('opt', required_attrs.merge(display_name: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes upstreams when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_beyondcorp_security_gateway_application('opt', required_attrs.merge(upstreams: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_beyondcorp_security_gateway_application', 'opt')
        expect(config).to have_key('upstreams')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_beyondcorp_security_gateway_application('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_beyondcorp_security_gateway_application('first', required_attrs)
        synth.google_beyondcorp_security_gateway_application('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_beyondcorp_security_gateway_application')
