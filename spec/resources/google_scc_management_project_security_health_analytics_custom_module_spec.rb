...
# Resource: Manages a google_scc_management_project_security_health_analytics_custom_module resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleSccManagementProjectSecurityHealthAnalyticsCustomModule do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { {} }

  describe ':google_scc_management_project_security_health_analytics_custom_module' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_scc_management_project_security_health_analytics_custom_module('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_scc_management_project_security_health_analytics_custom_module('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_scc_management_project_security_health_analytics_custom_module)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.update_time).to eq("${google_scc_management_project_security_health_analytics_custom_module.test.update_time}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_scc_management_project_security_health_analytics_custom_module('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes display_name when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_scc_management_project_security_health_analytics_custom_module('opt', required_attrs.merge(display_name: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_scc_management_project_security_health_analytics_custom_module', 'opt')
        expect(config).to have_key('display_name')
      end
      ...
      it 'includes enablement_state when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_scc_management_project_security_health_analytics_custom_module('opt', required_attrs.merge(enablement_state: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_scc_management_project_security_health_analytics_custom_module', 'opt')
        expect(config).to have_key('enablement_state')
      end
      ...
      it 'includes location when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_scc_management_project_security_health_analytics_custom_module('opt', required_attrs.merge(location: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_scc_management_project_security_health_analytics_custom_module', 'opt')
        expect(config).to have_key('location')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_scc_management_project_security_health_analytics_custom_module('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_scc_management_project_security_health_analytics_custom_module', 'typed')
      end
    end
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_scc_management_project_security_health_analytics_custom_module('first', required_attrs)
        synth.google_scc_management_project_security_health_analytics_custom_module('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_scc_management_project_security_health_analytics_custom_module')
