...
# Resource: Manages a google_chronicle_data_access_label resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleChronicleDataAccessLabel do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { data_access_label_id: 'test-value', instance: 'test-value', location: 'test-value', udm_query: 'test-value' } }

  describe ':google_chronicle_data_access_label' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_chronicle_data_access_label('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_chronicle_data_access_label', 'test')
        validate_required_attributes(config, [:data_access_label_id, :instance, :location, :udm_query])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_chronicle_data_access_label('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_chronicle_data_access_label)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.project).to eq("${google_chronicle_data_access_label.test.project}")
        expect(ref.update_time).to eq("${google_chronicle_data_access_label.test.update_time}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_chronicle_data_access_label('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_chronicle_data_access_label('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_chronicle_data_access_label', 'opt')
        expect(config).to have_key('description')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_chronicle_data_access_label('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_chronicle_data_access_label', 'typed')
        expect(config['data_access_label_id']).to be_a(String)
        expect(config['instance']).to be_a(String)
        expect(config['location']).to be_a(String)
        expect(config['udm_query']).to be_a(String)
      end
    end
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_chronicle_data_access_label('first', required_attrs)
        synth.google_chronicle_data_access_label('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_chronicle_data_access_label')
