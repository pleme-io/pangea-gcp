...
# Resource: Manages a google_eventarc_channel resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleEventarcChannel do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { location: 'test-value', name: 'test-value' } }

  describe ':google_eventarc_channel' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_eventarc_channel('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_eventarc_channel('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_eventarc_channel)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_eventarc_channel('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes crypto_key_name when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_eventarc_channel('opt', required_attrs.merge(crypto_key_name: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes third_party_provider when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_eventarc_channel('opt', required_attrs.merge(third_party_provider: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_eventarc_channel', 'opt')
        expect(config).to have_key('third_party_provider')
      end

      it 'omits third_party_provider when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_eventarc_channel('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_eventarc_channel', 'minimal')
        expect(config).not_to have_key('third_party_provider')
      end
    end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_eventarc_channel('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_eventarc_channel', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_eventarc_channel('first', required_attrs)
        synth.google_eventarc_channel('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_eventarc_channel')
