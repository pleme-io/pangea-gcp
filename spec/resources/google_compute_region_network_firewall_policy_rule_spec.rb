...
# Resource: Manages a google_compute_region_network_firewall_policy_rule resource
  ...
  describe ':google_compute_region_network_firewall_policy_rule' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.google_compute_region_network_firewall_policy_rule('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_compute_region_network_firewall_policy_rule('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_compute_region_network_firewall_policy_rule)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_region_network_firewall_policy_rule', 'opt')
        expect(config).to have_key('description')
      end
      ...
      it 'includes disabled when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('opt', required_attrs.merge(disabled: true))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_region_network_firewall_policy_rule', 'opt')
        expect(config).to have_key('disabled')
      end
      ...
      it 'includes enable_logging when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('opt', required_attrs.merge(enable_logging: true))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_region_network_firewall_policy_rule', 'opt')
        expect(config).to have_key('enable_logging')
      end
      ...
      it 'includes rule_name when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('opt', required_attrs.merge(rule_name: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_region_network_firewall_policy_rule', 'opt')
        expect(config).to have_key('rule_name')
      end
      ...
      it 'includes security_profile_group when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('opt', required_attrs.merge(security_profile_group: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_region_network_firewall_policy_rule', 'opt')
        expect(config).to have_key('security_profile_group')
      end
      ...
      it 'includes target_secure_tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('opt', required_attrs.merge(target_secure_tags: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_region_network_firewall_policy_rule', 'opt')
        expect(config).to have_key('target_secure_tags')
      end
      ...
      it 'includes target_service_accounts when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('opt', required_attrs.merge(target_service_accounts: ['test-value']))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_region_network_firewall_policy_rule', 'opt')
        expect(config).to have_key('target_service_accounts')
      end
      ...
      it 'includes tls_inspect when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('opt', required_attrs.merge(tls_inspect: true))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_region_network_firewall_policy_rule', 'opt')
        expect(config).to have_key('tls_inspect')
      end
    ...
    context 'boolean fields' do
      [true, false].each do |val|
        it "accepts disabled=#{val}" do
          ...
          synth.google_compute_region_network_firewall_policy_rule("bool_#{val}", attrs)
          result = normalize_synthesis(synth.synthesis)
          config = validate_resource_structure(result, 'google_compute_region_network_firewall_policy_rule', "bool_#{val}")
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_compute_region_network_firewall_policy_rule', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_region_network_firewall_policy_rule('first', required_attrs)
        synth.google_compute_region_network_firewall_policy_rule('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_compute_region_network_firewall_policy_rule')
