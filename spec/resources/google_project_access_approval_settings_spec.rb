...
# Resource: Manages a google_project_access_approval_settings resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleProjectAccessApprovalSettings do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { enrolled_services: [{ 'key1' => 'val1' }], project_id: 'test-value' } }

  describe ':google_project_access_approval_settings' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_project_access_approval_settings('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_project_access_approval_settings', 'test')
        validate_required_attributes(config, [:enrolled_services, :project_id])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_project_access_approval_settings('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_project_access_approval_settings)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.notification_emails).to eq("${google_project_access_approval_settings.test.notification_emails}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_project_access_approval_settings('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes active_key_version when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_project_access_approval_settings('opt', required_attrs.merge(active_key_version: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes project when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_project_access_approval_settings('opt', required_attrs.merge(project: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_project_access_approval_settings', 'opt')
        expect(config).to have_key('project')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_project_access_approval_settings('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_project_access_approval_settings', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_project_access_approval_settings('first', required_attrs)
        synth.google_project_access_approval_settings('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_project_access_approval_settings')
