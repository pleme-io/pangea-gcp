...
# Resource: Manages a google_storage_managed_folder resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleStorageManagedFolder do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { bucket: 'test-value', name: 'test-value' } }

  describe ':google_storage_managed_folder' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_storage_managed_folder('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_storage_managed_folder('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_storage_managed_folder)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_storage_managed_folder('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes force_destroy when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_storage_managed_folder('opt', required_attrs.merge(force_destroy: true))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_storage_managed_folder', 'opt')
        expect(config).to have_key('force_destroy')
      end
    ...
    context 'boolean fields' do
      [true, false].each do |val|
        it "accepts force_destroy=#{val}" do
          ...
          synth.google_storage_managed_folder("bool_#{val}", attrs)
          result = normalize_synthesis(synth.synthesis)
          config = validate_resource_structure(result, 'google_storage_managed_folder', "bool_#{val}")
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_storage_managed_folder('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_storage_managed_folder', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_storage_managed_folder('first', required_attrs)
        synth.google_storage_managed_folder('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_storage_managed_folder')
