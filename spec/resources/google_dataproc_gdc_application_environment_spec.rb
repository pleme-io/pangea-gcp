...
# Resource: Manages a google_dataproc_gdc_application_environment resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleDataprocGdcApplicationEnvironment do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { location: 'test-value', serviceinstance: 'test-value' } }

  describe ':google_dataproc_gdc_application_environment' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_dataproc_gdc_application_environment', 'test')
        validate_required_attributes(config, [:location, :serviceinstance])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_dataproc_gdc_application_environment('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_dataproc_gdc_application_environment)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.project).to eq("${google_dataproc_gdc_application_environment.test.project}")
        expect(ref.terraform_labels).to eq("${google_dataproc_gdc_application_environment.test.terraform_labels}")
        expect(ref.uid).to eq("${google_dataproc_gdc_application_environment.test.uid}")
        expect(ref.update_time).to eq("${google_dataproc_gdc_application_environment.test.update_time}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes annotations when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('opt', required_attrs.merge(annotations: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes application_environment_id when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('opt', required_attrs.merge(application_environment_id: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_dataproc_gdc_application_environment', 'opt')
        expect(config).to have_key('application_environment_id')
      end

      it 'omits application_environment_id when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes display_name when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('opt', required_attrs.merge(display_name: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_dataproc_gdc_application_environment', 'opt')
        expect(config).to have_key('display_name')
      end
      ...
      it 'includes labels when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('opt', required_attrs.merge(labels: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_dataproc_gdc_application_environment', 'opt')
        expect(config).to have_key('labels')
      end
      ...
      it 'includes namespace when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('opt', required_attrs.merge(namespace: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_dataproc_gdc_application_environment', 'opt')
        expect(config).to have_key('namespace')
      end
      ...
      it 'omits spark_application_environment_config when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_dataproc_gdc_application_environment', 'minimal')
        expect(config).not_to have_key('spark_application_environment_config')
      end
    end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_dataproc_gdc_application_environment', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_dataproc_gdc_application_environment('first', required_attrs)
        synth.google_dataproc_gdc_application_environment('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_dataproc_gdc_application_environment')
