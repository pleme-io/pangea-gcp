...
# Resource: Manages a google_bigtable_authorized_view resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleBigtableAuthorizedView do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { instance_name: 'test-value', name: 'test-value', table_name: 'test-value' } }

  describe ':google_bigtable_authorized_view' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_bigtable_authorized_view('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_bigtable_authorized_view', 'test')
        validate_required_attributes(config, [:instance_name, :name, :table_name])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_bigtable_authorized_view)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_bigtable_authorized_view('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'omits subset_view when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        ...
        expect(config).not_to have_key('subset_view')
      end
    end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_bigtable_authorized_view('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_bigtable_authorized_view', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_bigtable_authorized_view('first', required_attrs)
        synth.google_bigtable_authorized_view('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_bigtable_authorized_view')
