...
# Resource: Manages a google_gemini_data_sharing_with_google_setting_binding resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleGeminiDataSharingWithGoogleSettingBinding do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { data_sharing_with_google_setting_id: 'test-value', setting_binding_id: 'test-value', target: 'test-value' } }

  describe ':google_gemini_data_sharing_with_google_setting_binding' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gemini_data_sharing_with_google_setting_binding('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_gemini_data_sharing_with_google_setting_binding', 'test')
        validate_required_attributes(config, [:data_sharing_with_google_setting_id, :setting_binding_id, :target])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_gemini_data_sharing_with_google_setting_binding('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_gemini_data_sharing_with_google_setting_binding)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.project).to eq("${google_gemini_data_sharing_with_google_setting_binding.test.project}")
        expect(ref.terraform_labels).to eq("${google_gemini_data_sharing_with_google_setting_binding.test.terraform_labels}")
        expect(ref.update_time).to eq("${google_gemini_data_sharing_with_google_setting_binding.test.update_time}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gemini_data_sharing_with_google_setting_binding('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes labels when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gemini_data_sharing_with_google_setting_binding('opt', required_attrs.merge(labels: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_gemini_data_sharing_with_google_setting_binding', 'opt')
        expect(config).to have_key('labels')
      end
      ...
      it 'includes location when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gemini_data_sharing_with_google_setting_binding('opt', required_attrs.merge(location: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_gemini_data_sharing_with_google_setting_binding', 'opt')
        expect(config).to have_key('location')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gemini_data_sharing_with_google_setting_binding('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_gemini_data_sharing_with_google_setting_binding', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gemini_data_sharing_with_google_setting_binding('first', required_attrs)
        synth.google_gemini_data_sharing_with_google_setting_binding('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_gemini_data_sharing_with_google_setting_binding')
