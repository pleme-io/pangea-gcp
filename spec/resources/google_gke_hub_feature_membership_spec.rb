...
# Resource: Manages a google_gke_hub_feature_membership resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleGkeHubFeatureMembership do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { feature: 'test-value', location: 'test-value', membership: 'test-value' } }

  describe ':google_gke_hub_feature_membership' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_hub_feature_membership('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_gke_hub_feature_membership', 'test')
        validate_required_attributes(config, [:feature, :location, :membership])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_gke_hub_feature_membership)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_hub_feature_membership('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'omits configmanagement when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
      ...
      it 'includes membership_location when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_hub_feature_membership('opt', required_attrs.merge(membership_location: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_gke_hub_feature_membership', 'opt')
        expect(config).to have_key('membership_location')
      end

      it 'omits membership_location when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_hub_feature_membership('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_gke_hub_feature_membership', 'minimal')
        expect(config).not_to have_key('membership_location')
      end
      ...
      it 'omits mesh when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_hub_feature_membership('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_gke_hub_feature_membership', 'minimal')
        expect(config).not_to have_key('mesh')
      end
      ...
      it 'omits policycontroller when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_hub_feature_membership('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_hub_feature_membership('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_gke_hub_feature_membership', 'typed')
        expect(config['feature']).to be_a(String)
        expect(config['location']).to be_a(String)
        expect(config['membership']).to be_a(String)
      end
    end
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_hub_feature_membership('first', required_attrs)
        synth.google_gke_hub_feature_membership('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_gke_hub_feature_membership')
