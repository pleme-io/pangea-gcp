...
# Resource: Manages a google_discovery_engine_chat_engine resource
  ...
  describe ':google_discovery_engine_chat_engine' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.google_discovery_engine_chat_engine('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_discovery_engine_chat_engine', 'test')
        validate_required_attributes(config, [:chat_engine_config, :collection_id, :data_store_ids, :display_name, :engine_id, :location])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_discovery_engine_chat_engine('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_discovery_engine_chat_engine)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_discovery_engine_chat_engine('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes industry_vertical when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_discovery_engine_chat_engine('opt', required_attrs.merge(industry_vertical: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_discovery_engine_chat_engine', 'opt')
        expect(config).to have_key('industry_vertical')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_discovery_engine_chat_engine('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_discovery_engine_chat_engine('first', required_attrs)
        synth.google_discovery_engine_chat_engine('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_discovery_engine_chat_engine')
