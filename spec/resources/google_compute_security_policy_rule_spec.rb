...
# Resource: Manages a google_compute_security_policy_rule resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleComputeSecurityPolicyRule do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { action: 'test-value', priority: 3.14, security_policy: 'test-value' } }

  describe ':google_compute_security_policy_rule' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_security_policy_rule('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_compute_security_policy_rule', 'test')
        validate_required_attributes(config, [:action, :priority, :security_policy])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_compute_security_policy_rule)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_security_policy_rule('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_security_policy_rule('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_security_policy_rule', 'opt')
        expect(config).to have_key('description')
      end
      ...
      it 'includes preview when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_security_policy_rule('opt', required_attrs.merge(preview: true))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_compute_security_policy_rule', 'opt')
        expect(config).to have_key('preview')
      end
    ...
    context 'boolean fields' do
      [true, false].each do |val|
        it "accepts preview=#{val}" do
          ...
          synth.google_compute_security_policy_rule("bool_#{val}", attrs)
          result = normalize_synthesis(synth.synthesis)
          config = validate_resource_structure(result, 'google_compute_security_policy_rule', "bool_#{val}")
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_security_policy_rule('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_compute_security_policy_rule', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_compute_security_policy_rule('first', required_attrs)
        synth.google_compute_security_policy_rule('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_compute_security_policy_rule')
