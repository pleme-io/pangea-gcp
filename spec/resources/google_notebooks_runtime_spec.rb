...
# Resource: Manages a google_notebooks_runtime resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleNotebooksRuntime do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { location: 'test-value', name: 'test-value' } }

  describe ':google_notebooks_runtime' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_notebooks_runtime('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_notebooks_runtime)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.project).to eq("${google_notebooks_runtime.test.project}")
        expect(ref.state).to eq("${google_notebooks_runtime.test.state}")
        expect(ref.terraform_labels).to eq("${google_notebooks_runtime.test.terraform_labels}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_notebooks_runtime('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes labels when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_notebooks_runtime('opt', required_attrs.merge(labels: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_notebooks_runtime', 'opt')
        expect(config).to have_key('labels')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_notebooks_runtime('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_notebooks_runtime', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_notebooks_runtime('first', required_attrs)
        synth.google_notebooks_runtime('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_notebooks_runtime')
