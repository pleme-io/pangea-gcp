...
# Resource: Manages a google_cloud_asset_organization_feed resource
  ...
  describe ':google_cloud_asset_organization_feed' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.google_cloud_asset_organization_feed('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_cloud_asset_organization_feed', 'test')
        validate_required_attributes(config, [:billing_project, :feed_id, :feed_output_config, :org_id])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_cloud_asset_organization_feed)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_cloud_asset_organization_feed('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_cloud_asset_organization_feed', 'full')
    ...
    context 'optional attributes' do
      it 'includes asset_names when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_cloud_asset_organization_feed('opt', required_attrs.merge(asset_names: ['test-value']))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes asset_types when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_cloud_asset_organization_feed('opt', required_attrs.merge(asset_types: ['test-value']))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_cloud_asset_organization_feed', 'opt')
        expect(config).to have_key('asset_types')
      end
      ...
      it 'includes content_type when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_cloud_asset_organization_feed('opt', required_attrs.merge(content_type: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_cloud_asset_organization_feed', 'opt')
        expect(config).to have_key('content_type')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_cloud_asset_organization_feed('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_cloud_asset_organization_feed('first', required_attrs)
        synth.google_cloud_asset_organization_feed('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_cloud_asset_organization_feed')
