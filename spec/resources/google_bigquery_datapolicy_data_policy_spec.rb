...
# Resource: Manages a google_bigquery_datapolicy_data_policy resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleBigqueryDatapolicyDataPolicy do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { data_policy_id: 'test-value', data_policy_type: 'test-value', location: 'test-value', policy_tag: 'test-value' } }

  describe ':google_bigquery_datapolicy_data_policy' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_bigquery_datapolicy_data_policy('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_bigquery_datapolicy_data_policy', 'test')
        validate_required_attributes(config, [:data_policy_id, :data_policy_type, :location, :policy_tag])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_bigquery_datapolicy_data_policy)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_bigquery_datapolicy_data_policy('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_bigquery_datapolicy_data_policy('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_bigquery_datapolicy_data_policy', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_bigquery_datapolicy_data_policy('first', required_attrs)
        synth.google_bigquery_datapolicy_data_policy('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_bigquery_datapolicy_data_policy')
