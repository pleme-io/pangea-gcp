...
# Resource: Manages a google_iap_tunnel_dest_group resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleIapTunnelDestGroup do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { group_name: 'test-value' } }

  describe ':google_iap_tunnel_dest_group' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iap_tunnel_dest_group('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_iap_tunnel_dest_group)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iap_tunnel_dest_group('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes cidrs when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iap_tunnel_dest_group('opt', required_attrs.merge(cidrs: ['test-value']))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes fqdns when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iap_tunnel_dest_group('opt', required_attrs.merge(fqdns: ['test-value']))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_iap_tunnel_dest_group', 'opt')
        expect(config).to have_key('fqdns')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iap_tunnel_dest_group('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_iap_tunnel_dest_group', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iap_tunnel_dest_group('first', required_attrs)
        synth.google_iap_tunnel_dest_group('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_iap_tunnel_dest_group')
