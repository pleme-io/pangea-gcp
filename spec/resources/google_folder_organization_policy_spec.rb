...
# Resource: Manages a google_folder_organization_policy resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleFolderOrganizationPolicy do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { constraint: 'test-value', folder: 'test-value' } }

  describe ':google_folder_organization_policy' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_folder_organization_policy('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_folder_organization_policy', 'test')
        validate_required_attributes(config, [:constraint, :folder])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_folder_organization_policy)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_folder_organization_policy('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_folder_organization_policy('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_folder_organization_policy', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_folder_organization_policy('first', required_attrs)
        synth.google_folder_organization_policy('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_folder_organization_policy')
