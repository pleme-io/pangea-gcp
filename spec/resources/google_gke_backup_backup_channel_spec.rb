...
# Resource: Manages a google_gke_backup_backup_channel resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleGkeBackupBackupChannel do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { destination_project: 'test-value', location: 'test-value', name: 'test-value' } }

  describe ':google_gke_backup_backup_channel' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_backup_backup_channel('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_gke_backup_backup_channel)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.project).to eq("${google_gke_backup_backup_channel.test.project}")
        expect(ref.terraform_labels).to eq("${google_gke_backup_backup_channel.test.terraform_labels}")
        expect(ref.uid).to eq("${google_gke_backup_backup_channel.test.uid}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_backup_backup_channel('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_backup_backup_channel('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_gke_backup_backup_channel', 'opt')
        expect(config).to have_key('description')
      end
      ...
      it 'includes labels when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_backup_backup_channel('opt', required_attrs.merge(labels: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_gke_backup_backup_channel', 'opt')
        expect(config).to have_key('labels')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_backup_backup_channel('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_gke_backup_backup_channel', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_gke_backup_backup_channel('first', required_attrs)
        synth.google_gke_backup_backup_channel('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_gke_backup_backup_channel')
