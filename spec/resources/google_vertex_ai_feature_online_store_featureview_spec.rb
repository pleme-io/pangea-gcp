...
# Resource: Manages a google_vertex_ai_feature_online_store_featureview resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleVertexAiFeatureOnlineStoreFeatureview do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { feature_online_store: 'test-value' } }

  describe ':google_vertex_ai_feature_online_store_featureview' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_vertex_ai_feature_online_store_featureview('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_vertex_ai_feature_online_store_featureview', 'test')
        validate_required_attributes(config, [:feature_online_store])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_vertex_ai_feature_online_store_featureview('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_vertex_ai_feature_online_store_featureview)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.terraform_labels).to eq("${google_vertex_ai_feature_online_store_featureview.test.terraform_labels}")
        expect(ref.update_time).to eq("${google_vertex_ai_feature_online_store_featureview.test.update_time}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_vertex_ai_feature_online_store_featureview('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'omits big_query_source when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
      ...
      it 'omits feature_registry_source when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_vertex_ai_feature_online_store_featureview('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_vertex_ai_feature_online_store_featureview', 'minimal')
        expect(config).not_to have_key('feature_registry_source')
      end
      it 'includes labels when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_vertex_ai_feature_online_store_featureview('opt', required_attrs.merge(labels: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_vertex_ai_feature_online_store_featureview', 'opt')
        expect(config).to have_key('labels')
      end
      ...
      it 'includes name when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_vertex_ai_feature_online_store_featureview('opt', required_attrs.merge(name: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_vertex_ai_feature_online_store_featureview', 'opt')
        expect(config).to have_key('name')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_vertex_ai_feature_online_store_featureview('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_vertex_ai_feature_online_store_featureview', 'typed')
        expect(config['feature_online_store']).to be_a(String)
      end
    end
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_vertex_ai_feature_online_store_featureview('first', required_attrs)
        synth.google_vertex_ai_feature_online_store_featureview('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_vertex_ai_feature_online_store_featureview')
