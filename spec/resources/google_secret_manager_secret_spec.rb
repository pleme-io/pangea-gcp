...
# Resource: Manages a google_secret_manager_secret resource
  ...
  describe ':google_secret_manager_secret' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.google_secret_manager_secret('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_secret_manager_secret', 'test')
        validate_required_attributes(config, [:replication, :secret_id])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_secret_manager_secret('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_secret_manager_secret)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.name).to eq("${google_secret_manager_secret.test.name}")
        expect(ref.project).to eq("${google_secret_manager_secret.test.project}")
        expect(ref.terraform_labels).to eq("${google_secret_manager_secret.test.terraform_labels}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes annotations when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('opt', required_attrs.merge(annotations: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes deletion_protection when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('opt', required_attrs.merge(deletion_protection: true))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_secret_manager_secret', 'opt')
        expect(config).to have_key('deletion_protection')
      end
      ...
      it 'includes labels when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('opt', required_attrs.merge(labels: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_secret_manager_secret', 'opt')
        expect(config).to have_key('labels')
      end
      ...
      it 'includes tags when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('opt', required_attrs.merge(tags: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_secret_manager_secret', 'opt')
        expect(config).to have_key('tags')
      end
      ...
      it 'includes topics when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('opt', required_attrs.merge(topics: [{ 'key1' => 'val1' }]))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_secret_manager_secret', 'opt')
        expect(config).to have_key('topics')
      end
      ...
      it 'includes ttl when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('opt', required_attrs.merge(ttl: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_secret_manager_secret', 'opt')
        expect(config).to have_key('ttl')
      end
      ...
      it 'includes version_aliases when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('opt', required_attrs.merge(version_aliases: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_secret_manager_secret', 'opt')
        expect(config).to have_key('version_aliases')
      end
      ...
      it 'includes version_destroy_ttl when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('opt', required_attrs.merge(version_destroy_ttl: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_secret_manager_secret', 'opt')
        expect(config).to have_key('version_destroy_ttl')
      end
    ...
    context 'boolean fields' do
      [true, false].each do |val|
        it "accepts deletion_protection=#{val}" do
          ...
          synth.google_secret_manager_secret("bool_#{val}", attrs)
          result = normalize_synthesis(synth.synthesis)
          config = validate_resource_structure(result, 'google_secret_manager_secret', "bool_#{val}")
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_secret_manager_secret('first', required_attrs)
        synth.google_secret_manager_secret('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_secret_manager_secret')
