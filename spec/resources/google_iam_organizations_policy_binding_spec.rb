...
# Resource: Manages a google_iam_organizations_policy_binding resource
  ...
  describe ':google_iam_organizations_policy_binding' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.google_iam_organizations_policy_binding('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_iam_organizations_policy_binding', 'test')
        validate_required_attributes(config, [:location, :organization, :policy, :policy_binding_id, :target])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_iam_organizations_policy_binding('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_iam_organizations_policy_binding)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.policy_uid).to eq("${google_iam_organizations_policy_binding.test.policy_uid}")
        expect(ref.uid).to eq("${google_iam_organizations_policy_binding.test.uid}")
        expect(ref.update_time).to eq("${google_iam_organizations_policy_binding.test.update_time}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_organizations_policy_binding('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes annotations when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_organizations_policy_binding('opt', required_attrs.merge(annotations: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes display_name when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_organizations_policy_binding('opt', required_attrs.merge(display_name: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_iam_organizations_policy_binding', 'opt')
        expect(config).to have_key('display_name')
      end
      ...
      it 'includes policy_kind when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_organizations_policy_binding('opt', required_attrs.merge(policy_kind: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_iam_organizations_policy_binding', 'opt')
        expect(config).to have_key('policy_kind')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_organizations_policy_binding('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_iam_organizations_policy_binding', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_organizations_policy_binding('first', required_attrs)
        synth.google_iam_organizations_policy_binding('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_iam_organizations_policy_binding')
