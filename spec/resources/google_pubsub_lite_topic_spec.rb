...
# Resource: Manages a google_pubsub_lite_topic resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GooglePubsubLiteTopic do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { name: 'test-value' } }

  describe ':google_pubsub_lite_topic' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_pubsub_lite_topic('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_pubsub_lite_topic)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_pubsub_lite_topic('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'omits partition_config when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_pubsub_lite_topic('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes region when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_pubsub_lite_topic('opt', required_attrs.merge(region: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_pubsub_lite_topic', 'opt')
        expect(config).to have_key('region')
      end
      ...
      it 'omits reservation_config when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_pubsub_lite_topic('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_pubsub_lite_topic', 'minimal')
        expect(config).not_to have_key('reservation_config')
      end
      ...
      it 'omits retention_config when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_pubsub_lite_topic('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_pubsub_lite_topic', 'minimal')
        expect(config).not_to have_key('retention_config')
      end
      it 'includes zone when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_pubsub_lite_topic('opt', required_attrs.merge(zone: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_pubsub_lite_topic', 'opt')
        expect(config).to have_key('zone')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_pubsub_lite_topic('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_pubsub_lite_topic', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_pubsub_lite_topic('first', required_attrs)
        synth.google_pubsub_lite_topic('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_pubsub_lite_topic')
