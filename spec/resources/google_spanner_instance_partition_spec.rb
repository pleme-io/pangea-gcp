...
# Resource: Manages a google_spanner_instance_partition resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleSpannerInstancePartition do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { config: 'test-value', display_name: 'test-value', instance: 'test-value', name: 'test-value' } }

  describe ':google_spanner_instance_partition' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_spanner_instance_partition('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_spanner_instance_partition', 'test')
        validate_required_attributes(config, [:config, :display_name, :instance, :name])
      end
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_spanner_instance_partition)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_spanner_instance_partition('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes node_count when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_spanner_instance_partition('opt', required_attrs.merge(node_count: 3.14))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_spanner_instance_partition', 'opt')
        expect(config).to have_key('node_count')
      end
      ...
      it 'includes processing_units when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_spanner_instance_partition('opt', required_attrs.merge(processing_units: 3.14))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_spanner_instance_partition', 'opt')
        expect(config).to have_key('processing_units')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_spanner_instance_partition('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_spanner_instance_partition', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_spanner_instance_partition('first', required_attrs)
        synth.google_spanner_instance_partition('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_spanner_instance_partition')
