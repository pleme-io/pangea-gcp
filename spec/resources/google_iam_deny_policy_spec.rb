...
# Resource: Manages a google_iam_deny_policy resource
# Source: terraform-apply

require 'spec_helper'

RSpec.describe Pangea::Resources::GoogleIamDenyPolicy do
  include Pangea::Testing::SynthesisTestHelpers

  let(:required_attrs) { { name: 'test-value', parent: 'test-value', rules: [{ 'key1' => 'val1' }] } }

  describe ':google_iam_deny_policy' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_deny_policy('test', required_attrs)
      ...
      it 'returns a ResourceReference' do
        ...
        expect(ref.resource_type).to eq(:google_iam_deny_policy)
      end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_deny_policy('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      ...
      it 'includes display_name when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_deny_policy('opt', required_attrs.merge(display_name: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_iam_deny_policy', 'opt')
        expect(config).to have_key('display_name')
      end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_deny_policy('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        config = validate_resource_structure(result, 'google_iam_deny_policy', 'typed')
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_iam_deny_policy('first', required_attrs)
        synth.google_iam_deny_policy('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_iam_deny_policy')
