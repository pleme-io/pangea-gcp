...
# Resource: Manages a google_network_services_endpoint_policy resource
  ...
  describe ':google_network_services_endpoint_policy' do
    context 'with required attributes only' do
      it 'synthesizes valid Terraform JSON' do
        ...
        synth.google_network_services_endpoint_policy('test', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        validate_terraform_structure(result, :resource)
        config = validate_resource_structure(result, 'google_network_services_endpoint_policy', 'test')
        validate_required_attributes(config, [:endpoint_matcher, :name, :type])
      end

      it 'returns a ResourceReference' do
        synth = create_synthesizer
        synth.extend(described_class)
        ref = synth.google_network_services_endpoint_policy('test', required_attrs)

        expect(ref).to be_a(Pangea::Resources::ResourceReference)
        expect(ref.resource_type).to eq(:google_network_services_endpoint_policy)
      end
      ...
      it 'provides output references' do
        ...
        expect(ref.update_time).to eq("${google_network_services_endpoint_policy.test.update_time}")
      end
    end
    ...
    context 'with all attributes' do
      ...
      it 'synthesizes with optional attributes' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_network_services_endpoint_policy('full', all_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'optional attributes' do
      it 'includes authorization_policy when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_network_services_endpoint_policy('opt', required_attrs.merge(authorization_policy: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_network_services_endpoint_policy', 'opt')
        expect(config).to have_key('authorization_policy')
      end

      it 'omits authorization_policy when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        ...
        expect(config).not_to have_key('authorization_policy')
      end
      it 'includes client_tls_policy when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_network_services_endpoint_policy('opt', required_attrs.merge(client_tls_policy: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_network_services_endpoint_policy', 'opt')
        expect(config).to have_key('client_tls_policy')
      end

      it 'omits client_tls_policy when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_network_services_endpoint_policy('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
      ...
      it 'includes description when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_network_services_endpoint_policy('opt', required_attrs.merge(description: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_network_services_endpoint_policy', 'opt')
        expect(config).to have_key('description')
      end
      ...
      it 'includes labels when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_network_services_endpoint_policy('opt', required_attrs.merge(labels: { 'key1' => 'val1' }))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_network_services_endpoint_policy', 'opt')
        expect(config).to have_key('labels')
      end
      ...
      it 'includes server_tls_policy when provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_network_services_endpoint_policy('opt', required_attrs.merge(server_tls_policy: 'test-value'))
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_network_services_endpoint_policy', 'opt')
        expect(config).to have_key('server_tls_policy')
      end
      ...
      it 'omits traffic_port_selector when not provided' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_network_services_endpoint_policy('minimal', required_attrs)
        result = normalize_synthesis(synth.synthesis)
        config = validate_resource_structure(result, 'google_network_services_endpoint_policy', 'minimal')
        expect(config).not_to have_key('traffic_port_selector')
      end
    end
    ...
    context 'attribute types' do
      it 'validates expected attribute types' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_network_services_endpoint_policy('typed', required_attrs)
        result = normalize_synthesis(synth.synthesis)
    ...
    context 'multiple instances' do
      it 'synthesizes multiple resources independently' do
        synth = create_synthesizer
        synth.extend(described_class)
        synth.google_network_services_endpoint_policy('first', required_attrs)
        synth.google_network_services_endpoint_policy('second', required_attrs)
        result = normalize_synthesis(synth.synthesis)

        resources = result.dig('resource', 'google_network_services_endpoint_policy')
