...
module Pangea::Resources
  module GooglePubsubSubscription
    ...
    define_resource :google_pubsub_subscription,
      ...
      outputs: { id: :id },
      map: [:name, :topic],
      map_present: [:bigquery_config, :cloud_storage_config, :dead_letter_policy, :expiration_policy, :filter, :labels, :message_retention_duration, :message_transforms, :push_config, :retry_policy],
