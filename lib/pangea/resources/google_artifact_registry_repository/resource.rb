...
module Pangea::Resources
  module GoogleArtifactRegistryRepository
    ...
    define_resource :google_artifact_registry_repository,
      ...
      map_present: [:cleanup_policies, :deletion_policy, :description, :docker_config, :kms_key_name, :labels, :location, :maven_config, :mode, :project, :remote_repository_config, :virtual_repository_config, :vulnerability_scanning_config],
