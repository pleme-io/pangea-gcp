...
module Pangea::Resources
  module GoogleDnsManagedZone
    ...
    define_resource :google_dns_managed_zone,
      ...
      outputs: { id: :id },
      map: [:dns_name, :name],
      map_present: [:cloud_logging_config, :deletion_policy, :description, :dnssec_config, :forwarding_config, :labels, :peering_config, :private_visibility_config, :project, :visibility],
